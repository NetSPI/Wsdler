...
interface Constants {
    ...
    String WSDL11_NS = "http://schemas.xmlsoap.org/wsdl/";
    String SOAP_ENCODING_NS = "http://schemas.xmlsoap.org/soap/encoding/";
    String SOAP11_ENVELOPE_NS = "http://schemas.xmlsoap.org/soap/envelope/";
    String SOAP_HTTP_TRANSPORT = "http://schemas.xmlsoap.org/soap/http";
    String SOAP_HTTP_BINDING_NS = "http://schemas.xmlsoap.org/wsdl/soap/";
    ...
    String XSI_NS_2000 = "http://www.w3.org/2000/XMLSchema-instance";
    String SOAP12_ENVELOPE_NS = "http://www.w3.org/2003/05/soap-envelope";
    String WADL10_NS = "http://research.sun.com/wadl/2006/10";
    String WADL11_NS = "http://wadl.dev.java.net/2009/02";
