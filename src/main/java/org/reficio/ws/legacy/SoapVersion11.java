...
class SoapVersion11 extends AbstractSoapVersion {
    ...
    private SoapVersion11() {
        try {
            ...
            URL soapSchemaXmlResource = ResourceUtils.getResourceWithAbsolutePackagePath(
                    "/xsds/", "soapEnvelope.xsd");
            soapSchemaXml = SchemaDocument.Factory.parse(soapSchemaXmlResource, options);
            ...
            soapEncodingXml = SchemaDocument.Factory.parse(soapEncodingXmlResource, options);
